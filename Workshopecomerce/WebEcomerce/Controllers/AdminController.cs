...
namespace WebEcomerce.Controllers
{
    public class AdminController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Edit(string Id, string ProductName, string ProductDetail, double Price, int Amount,string ImagePath, IFormFile ImageFile)
        {
            modelProduct.Id = Id;
            modelProduct.ProductName = ProductName;
            modelProduct.ProductDetail = ProductDetail;
            modelProduct.Price = Price;
            modelProduct.Amount = Amount;
            modelProduct.ImagePath = ImageFile != null ? UploadFile("storage-image-test", ImageFile) : ImagePath;
